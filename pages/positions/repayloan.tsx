...
const Repayloan: NextPage = () => {
  ...
  const style = {
    ...
    comingSoonPoster: 'bg-neutrals-900 h-[46rem] mt-5 rounded-lg flex justify-center items-center text-neutrals-200/20 text-xl',
    ...
    PNLContainer: 'w-72 h-32 bg-neutrals-800 rounded-md drop-shadow-md flex justify-center items-center text-neutrals-200/20 ml-auto',
          ...
          <Tab.Panels>
            <Tab.Panel>
              ...
              <div className={style.lpTokensOutstandingLoanAmountContainer}>
                ...
                {/* User Input */}
                <TokenUserInput token0={token0} token1={token1} />
              </div> 
